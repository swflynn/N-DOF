...
!==============================================================================!
!    Things to Do:
! Develop 2D calculations
! Change Potential to no longer be seperable
!==============================================================================!
!    Discussion:
...
!V:=c1*(x+y)^2+c2*(x-y)^2 (2D potential,different omega)
!==============================================================================!
implicit none
...
enddo 
close(20)
open(22,file='true.dat')
do i=0,NG
do j=0,NG
    write(22,*) omega(1)*(0.5+i) + omega(2)*(0.5+j)
enddo 
enddo
close(22)
!==============================================================================!
