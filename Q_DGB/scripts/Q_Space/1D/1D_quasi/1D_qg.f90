...
!q2             ==> (Dimen,Nsobol): Sequence for Potential Evaluation
...
double precision::E0,lsum,prod_omega,Tsum,pot_ene,alpha_par,Tpre
!==============================================================================!
double precision,allocatable::q0(:),force(:),q(:,:),q2(:,:),z(:,:),z2(:,:)
double precision,allocatable::Hess(:,:),omega(:),U(:,:),alpha(:),Tmat(:,:)
double precision,allocatable::lmat(:,:),Smat(:,:),S1mat(:,:),eigenvalues(:)
double precision,allocatable::Vmat(:,:),Hmat(:,:)
!==============================================================================!
