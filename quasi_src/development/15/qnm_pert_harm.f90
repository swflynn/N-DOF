...
! This code replaces the potential difference with a harmonic potential*0.1
...
! Not calling apotential here, we are simply taking a pertebation of the harmonic potential!
! The harmonic potential is analytically known we simply compute it!
! Note the old harmonic potential had an extra factor of omega that is now removed!
...
!=================These tests were to see if our transfomrations are correct===============!
!==============================Remove once done testing====================================!
! define the potential difference to be 0.1*harmonic potential, small pertebation
potdif = 0d0
      DO j=1,Dim
          potdif = potdif+ 0.1*(0.5*omega(j)*y(j)**2)
      END DO
