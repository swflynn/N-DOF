! This version of the code tests to see if we are computing the potential correct.
! Calculates the harmonic potential using our Normal Mode transformations, and then using the Hessian
! This version gives the proper potential using both methods! 10/25/17 (no factor of 2 issue)
! This code does not have the difference potential, we were just testing the potential call statement
Module quasi_nm
 IMPLICIT NONE 
!============================================================================================!
!======================================Global paramaters=====================================!
...
! Compute Hessian 
   ...
   enddo
   DO i = 1, Dim
      U(i,k) = SQRT(1/omega(k)) / sqrt_mass(i)*U(i,k)   !VM corrected
   END DO
!   write(*,*) 'k ', k, 'omega(k)', omega(k)
!   write(*,*) 'U: ', U(:,k)
!   write(*,*) 'mass', sqrt_mass(:)
